...
<form class="fields-product-admin" method="POST" action="update_product.php" enctype="multipart/form-data">
    ...
    <input type="text" id="model-product-admin" name="model" maxlength="14" 
