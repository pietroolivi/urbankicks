...
CREATE TABLE IF NOT EXISTS PAGAMENTO (
     ...
     FOREIGN KEY (Int_Email) REFERENCES UTENTE(Email) ON DELETE NO ACTION ON UPDATE NO ACTION
);
...
CREATE TABLE IF NOT EXISTS ORDINE (
     ...
     FOREIGN KEY (Tipo) REFERENCES STATO_SPEDIZIONE(Tipo) ON DELETE NO ACTION ON UPDATE NO ACTION,
     FOREIGN KEY (Email) REFERENCES UTENTE(Email) ON DELETE NO ACTION ON UPDATE NO ACTION,
