...
\begin{document}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=400pt]{ER/erfinalesx.png}
		\caption{Schema ER finale 1/2.}
	\end{figure}
	\begin{figure}[H]
		\centering
		\includegraphics[width=400pt]{ER/erfinaledx.png}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=400pt]{ER/schemalogico/relsx.png}
		\caption{Schema Logico 1/2.}
	\end{figure}
	\begin{figure}[H]
		\centering
		\includegraphics[width=400pt]{ER/schemalogico/reldx.png}
